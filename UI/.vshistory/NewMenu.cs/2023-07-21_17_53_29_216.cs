...
namespace SevenDTDMono
{
    public class NewMenu : MonoBehaviour
    {
        ...
        private GUIStyle customBoxStyle;
        ...
        private void OnGUI()
        {
            ...
            customBoxStyle.normal.background = MakeTexture(2, 2, Color.green); ;
        ...
        private void Menu3()
        {
            ...
            customBoxStyle.normal.background = MakeTexture(2, 2, Color.blue);
