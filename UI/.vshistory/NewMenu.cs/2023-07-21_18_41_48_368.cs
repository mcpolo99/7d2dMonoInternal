...
namespace SevenDTDMono
{
    public class NewMenu : MonoBehaviour
    {
        ...
        private void Menu3()
        {
            ...
            foldout2 = CGUILayout.FoldableMenuHorizontal(foldout2, "Foldable Menu 2", () =>sdsda
            {
                // Content to show when the foldout is open for Foldable Menu 1
                // Add your UI elements here...
            ...
            foldout5 = CGUILayout.FoldableMenuHorizontal(foldout5, "Foldable Menu 5", () =>
            {
                ...
                #region
                //-<
                GUILayout.Label("L5 Content for Menu ", centeredLabelStyle); //here are all the items placed
                                                                             //>-
                #endregion
                GUILayout.EndVertical();
                GUILayout.BeginVertical(GUI.skin.box);
