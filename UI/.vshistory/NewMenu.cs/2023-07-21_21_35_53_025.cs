                       ...
                       // Add your UI elements here...
                        ...
                        { // Start a vertical layout group for the label and horizontal layout
                            ...
                            GUILayout.BeginVertical("buffs", GUI.skin.box);
                            {
                                ...
                                scrollBuff = GUILayout.BeginScrollView(scrollBuff, GUILayout.MaxWidth(300f),GUILayout.Height(200f));
                                {
                                        ...
                                        if (O._BuffNames.Count > 1)
                                        {
                                            ...
                                            foreach (string buffClass in O._BuffNames)
                                            {
                                                ...
                                                if (GUILayout.Button(buffClass))
                                                {
                                                    ...
                                                    O.localPlayer.Buffs.AddBuff(buffClass, -1, true, false, false, -1f);
