...
namespace SevenDTDMono
{
    public class NewMenu : MonoBehaviour
    {
        ...
        private void Menu0()
        {
            ...
            SETT.speed = CGUILayout.ToggleC(SETT.speed, "speed",Color.cyan,Color.blue,Color.red);//toggle on/off bool
            SETT.speed = CGUILayout.ToggleC(SETT.speed, "Game speed", Color.green, Color.red);//toggle on/off bool
            SETT.CmDm = CGUILayout.ToggleC(SETT.CmDm, "Creative/Debug Mode",Color.green, Color.red);//toggle on/off bool
            SETT.TESTTOG = CGUILayout.ToggleC(SETT.TESTTOG,"TESTTOG");
