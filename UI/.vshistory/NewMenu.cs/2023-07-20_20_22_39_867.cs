...
namespace SevenDTDMono
{
    public class NewMenu : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            {
                // Any cleanup or additional code you need to execute before destruction
                Destroy(Loader.gameObject);
                SETT.selfDestruct = false;
            }
        }
        ...
        private void OnGUI()
        {
            ...
            //if (drawDebug)
            //{
            //    windowRect1 = GUILayout.Window(windowID, windowRect1, Window, "Menu");
