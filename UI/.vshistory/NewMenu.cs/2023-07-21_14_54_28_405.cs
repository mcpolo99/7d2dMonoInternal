...
namespace SevenDTDMono
{
    public class NewMenu : MonoBehaviour
    {
        ...
        {
            _group = GUILayout.Toolbar(_group, CheatsString, GUI.skin.box); //creating the group for switch comand    
        ...
        private void Menu0()
        {
            ...
            //------------------------------------------------------------------------------
            foldout1 = CGUILayout.FoldableMenu(foldout1, "Foldable Menu 1", () =>
            {
        ...
        private void Menu3()
        {
            ...
            GUILayout.EndVertical();
            GUILayout.BeginVertical();
            GUILayout.VerticalSlider(10f, 0f, 50f);
            //if (GUILayout.Button("TextArea"))
            //{
