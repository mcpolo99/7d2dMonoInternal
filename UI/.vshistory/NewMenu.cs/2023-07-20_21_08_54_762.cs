...
namespace SevenDTDMono
{
    public class NewMenu : MonoBehaviour
    {
        ...
        private void Awake()
        {
            // Create a GUIStyle and set its normal and active background colors
            toggleStyle = new GUIStyle(GUI.skin.toggle);
            toggleStyle.normal.textColor = Color.white;    // Inactive color
            toggleStyle.active.textColor = Color.green;    // Active color
        }
        ...
        private void OnGUI()
        {
            ...
            toggleStyle.normal.background = MakeTex(2, 2, toggleColors.inactiveColor);
            toggleStyle.active.background = MakeTex(2, 2, toggleColors.activeColor);
        ...
        private void Menu0()
        {
            ...
            SETT.drpbp = GUILayout.Toggle(SETT.drpbp, "drpbk");//toggle on/off bool
            ...
            SETT.CmDm = GUILayout.Toggle(SETT.CmDm, "Creative/Debug Mode", toggleStyle);//toggle on/off bool
            GUILayout.Toggle(SETT.TESTTOG,"TESTTOG", toggleStyle);
