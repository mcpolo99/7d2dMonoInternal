                    ...
                    {  // Content to show when the foldout is open for Foldable Menu 1
                       // Add your UI elements here...
                        ...
                        { // Start a vertical layout group for the label and horizontal layout
                            ...
                            GUILayout.BeginHorizontal("buffs", GUI.skin.box);
                            {
                                if (CGUILayout.Button("BuffManager.Buffs.Clear"))
                                { 
                                    BuffManager.Buffs.Clear(); 
                                }
                                if (CGUILayout.Button("Buffs.ActiveBuffs.Clear()"))
                                {
                                    O.localPlayer.Buffs.ActiveBuffs.Clear();
                                }
                                if (CGUILayout.Button("localPlayer.Buffs.RemoveBuffs"))
                                {
                                    O.localPlayer.Buffs.RemoveBuffs();
                                }
                                if (CGUILayout.Button("Debug"))
                                {
                                    string watrstr = O.localPlayer.Buffs.GetCustomVar("$waterAmount").ToString();
                                    Log.Out(watrstr);
                                    //BuffManager.Buffs.Clear();
                                ...
                                if (CGUILayout.Button("modify all buffs"))
                                { 
                                }
                                ...
                                scrollBuff2 = GUILayout.BeginScrollView(scrollBuff2, GUILayout.MaxWidth(300f), GUILayout.Width(250f), GUILayout.Height(200f));
                                {
                                    if (O.localPlayer != null)
                                    {
                                        if (O.buffClasses.Count > 1)
                                        {
                                            foreach (BuffClass buffClass in O.buffClasses)
                                            {
                                                ...
                                                if (GUILayout.Button(buffClass.Name))
                                                {
                                                    ...
                                                    //EntityBuffs.BuffStatus buffStatus =
                                                    O.localPlayer.Buffs.AddBuff(buffClass.Name, -1, true, false, false, 200f);
                                                    // Your logic when the button is clicked
                                                }
