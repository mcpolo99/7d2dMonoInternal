...
namespace SevenDTDMono
{
    public class NewMenu : MonoBehaviour
    {
        ...
        private void Menu0()
        {
            ...
            CGUILayout.Button(ref SETT.TESTTOG,"Instant loot",Color.red,Color.green);
            CGUILayout.Button("Quick melt");
            CGUILayout.Button(ref SETT._QuickScrap, "Quick scrap",Color.cyan,Color.red);
            CGUILayout.Button(ref SETT._oneHit,"One hit block",Color.cyan,Color.red);//button toggle bool
            //------------------------------------------------------------------------------
