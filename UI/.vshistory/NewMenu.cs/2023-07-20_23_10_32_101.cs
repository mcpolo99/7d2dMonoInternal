...
namespace SevenDTDMono
{
    public class NewMenu : MonoBehaviour
    {
        ...
        private void Menu0()
        {
            ...
            SETT.speed = GUILayout.Toggle(SETT.speed, "Game speed", Color.green, Color.red);//toggle on/off bool
            SETT.CmDm = GUILayoutExtensions.ToggleWithColor(SETT.CmDm, "Creative/Debug Mode",Color.green, Color.red);//toggle on/off bool
