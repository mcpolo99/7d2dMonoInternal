...
namespace SevenDTDMono.Utils
{
    public static class CGUILayout
    {
        ...
        public static bool FoldableMenu(bool display, string label, System.Action content, params GUILayoutOption[] options)
        {
            ...
            GUIStyle headerStyle = new GUIStyle("ShurikenModuleTitle");
            headerStyle.fontStyle = FontStyle.Bold;
            headerStyle.fontSize = 12;
            headerStyle.border = new RectOffset(15, 7, 4, 4);
            headerStyle.fixedHeight = 22;
            headerStyle.contentOffset = new Vector2(20f, -2f);
        ...
        public static bool FoldableMenu1(bool display, string label, System.Action content, params GUILayoutOption[] options)
        {
            Color headerColor = display ? Color.green : Color.red;
            Color hoverColor = Color.cyan;
