...
namespace SevenDTDMono.Utils
{
    public static class CGUILayout
    {
        ...
        public static bool ToggleC(bool value, string label, Color activeColor, Color inactiveColor, params GUILayoutOption[] options)
        {
            ...
            toggleStyle.normal.textColor = Color.blue;      //Not activated 
            toggleStyle.onNormal.textColor = Color.blue;    //when activated
            toggleStyle.active.textColor = Color.red;       // When pressing/holding 
            ...
            toggleStyle.focused.textColor =new Color(0.5f, 0.2f, 0.8f); ;
