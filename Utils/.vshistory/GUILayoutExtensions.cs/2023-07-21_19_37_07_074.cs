...
namespace SevenDTDMono.Utils
{
    public static class CGUILayout
    {
        ...
        public static int Toolbar2(int selected, string[] texts, GUIStyle style, params GUILayoutOption[] options)
        {
            ...
            GUIStyle selectedStyle = new GUIStyle(style);
            selectedStyle.normal.textColor = activeColor;
            selectedStyle.hover.textColor = activeColor;
            selectedStyle.active.textColor = activeColor;

            GUIStyle normalStyle = new GUIStyle(style);
            normalStyle.normal.textColor = inactiveColor;
            normalStyle.hover.textColor = hoverColor;
            normalStyle.active.textColor = inactiveColor;

            int newSelected = GUILayout.Toolbar(selected, texts, selectedStyle, normalStyle, options);
