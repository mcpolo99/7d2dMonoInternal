...
namespace SevenDTDMono.Utils
{
    public static class CGUILayout
    {
        ...
        public static bool Button(string label, Color normal, Color active, Color hover, params GUILayoutOption[] options)
        {
            GUIStyle buttonStyle = new GUIStyle(GUI.skin.button);
        ...
        public static bool Button(string label, Color normal, Color active, params GUILayoutOption[] options)
        {
            GUIStyle buttonStyle = new GUIStyle(GUI.skin.button);
            Color hover = Color.cyan;
            buttonStyle.normal.textColor = normal;
