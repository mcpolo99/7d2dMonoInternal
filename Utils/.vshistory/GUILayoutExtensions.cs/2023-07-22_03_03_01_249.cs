...
namespace SevenDTDMono.Utils
{
    public static class CGUILayout
    {
        ...
        public static bool Button(string label, ref bool toggle, params GUILayoutOption[] options)
        {
            bool previousState = toggle;
            ...
            return previousState != toggle;
        }
        ublic static bool Button(string label, ref bool toggle, Action onClickAction = null, params GUILayoutOption[] options)
        {
            GUIStyle buttonStyle = new GUIStyle(GUI.skin.button);
            Color active = Color.green;
            Color inactive = Color.red;
