...
namespace SevenDTDMono.Utils
{
    public static class CGUILayout
    {
        ...
        public static int Toolbar2(int selected, string[] texts, GUIStyle style, Color activeColor, Color inactiveColor, Color hoverColor, params GUILayoutOption[] options)
        {
