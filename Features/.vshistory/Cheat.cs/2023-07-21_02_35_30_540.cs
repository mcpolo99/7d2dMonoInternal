            ...
            if (O.localPlayer)
            {
                ...
                if (RegenerationAmount > 0f)
                {
                    ...
                    {O.localPlayer.Stats.ResetStats();
                        O.localPlayer.Stats.Water.RegenerationAmount += 20f * EffectManager.GetValue(PassiveEffects.WaterLossPerStaminaPointGained, null, 1f, this.Entity, null, default(FastTags), true, true, true, true, 1, true, false);
                    ...
                    {
                        O.localPlayer.Stats.Water.RegenerationAmount -= 20f * EffectManager.GetValue(PassiveEffects.WaterLossPerHealthPointGained, null, 1f, this.Entity, null, default(FastTags), true, true, true, true, 1, true, false);
