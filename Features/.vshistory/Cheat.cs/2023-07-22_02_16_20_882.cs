    ...
    public class Cheat : MonoBehaviour
    {
        ...
        */
        ...
        public static void HealthNStamina()
        {
            ...
            O.localPlayer.Stats.Water.RegenerationAmount += O.localPlayer.Stats.Water.RegenerationAmount * EffectManager.GetValue(PassiveEffects.WaterLossPerHealthPointGained, null, 1f, O.localPlayer.enti, null, default(FastTags), true, true, true, true, 1, true, false);
