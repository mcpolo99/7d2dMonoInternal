    ...
    public class Cheat : MonoBehaviour
    {
        ...
        */
        ...
        public static void HealthNStamina()
        {
            ...
            O.localPlayer.Stats.Water.RegenerationAmount += O._entityplayerLocal.Stats.Water.RegenerationAmount * EffectManager.GetValue(PassiveEffects.WaterGain, null, 1f, O._entityplayerLocal, null, default(FastTags), true, true, true, true, 1, true, false);
