        ...
        */
        ...
        public static void HealthNStamina()
        {
            ...
            if (SETT._healthNstamina == true && O._entityplayerLocal != null)
            {
                ...
                O.localPlayer.Stats.Water.Value = O._entityplayerLocal.Stats.Water.Max;
                O.localPlayer.Stats.Food.Value = O._entityplayerLocal.Stats.Food.Max;
                O.localPlayer.Stats.Stamina.Value = O._entityplayerLocal.Stats.Stamina.Max;
                O.localPlayer.Stats.Health.Value = O._entityplayerLocal.Stats.Health.Max; 
